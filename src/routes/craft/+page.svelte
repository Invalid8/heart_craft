...
<main
	class="main animate-fade relative grid size-full h-svh place-content-center place-items-center bg-red-500/10 p-4 sm:p-6"
>
	<div
		class="box-in relative z-10 w-full max-w-3xl overflow-hidden rounded-xl bg-white/98 p-6 shadow-xl sm:w-xl md:w-3xl md:p-8"
	>
		<!-- Step indicator -->
